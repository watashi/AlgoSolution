...
int main(int argc, char *argv[]) {
  ...
  (void)argv;
      ...
      {
        PalindromesCount theObject;
        eq(0, theObject.count("aba", "b"),2);
    }
    {
        PalindromesCount theObject;
        eq(1, theObject.count("aa", "a"),3);
    }
    {
        PalindromesCount theObject;
        eq(2, theObject.count("aca", "bb"),0);
    }
    {
        PalindromesCount theObject;
        eq(3, theObject.count("abba", "abba"),3);
    }
    {
        PalindromesCount theObject;
        eq(4, theObject.count("topcoder", "coder"),0);
    }
